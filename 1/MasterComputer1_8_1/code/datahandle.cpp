...
*/
    ...
    unsigned int CRCFlag = CRCHandle(m_data.data,29);
...
HandleToComData DataHandle::ProcessDataHandle(bool flag)
{
    m_data.clear();
    m_data.data[0] = 0x09;
    m_data.data[1] = 0x0D;
    if(flag)
    {
        m_data.flag = HandleToComData::PROBEGINDATA;
        m_data.data[2] = 0x01;
    }
    else
    {
        m_data.flag = HandleToComData::PROENDDATA;
        m_data.data[2] = 0x02;
    }
