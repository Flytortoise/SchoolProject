...
//    TittleLabel = new QLabel(tr("串口调试:"));
    ...
    ClearTextButton = new QPushButton(tr("清空显示"));
    ClearTextButton->setEnabled(true);
    connect(ClearTextButton, SIGNAL(clicked(bool)),
            this, SLOT(MyClearText()));
    ...
    RecvDataTextEdit->setFixedHeight(120);
    SendDataTextEdit = new QTextEdit;
    SendDataTextEdit->setFixedHeight(40);
...
void ComPortWidget::CreateLayout()
{
    ...
    mainLayout->addWidget(ClearTextButton, 1, 3);
    ...
    mainLayout->addWidget(SendDataButton, 3, 3);
...
void ComPortWidget::MyClearText()
{
